					...
					<sf:form class="form-horizontal" modelAttribute="product">
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="brand">Enter
								brand Name</label>
							<div class="col-md-8">
								<sf:input type="text" path="brand" id="brand" placeholder="Brand"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description"
									rows="4" placeholder="Write a description product"
									class="form-control"></sf:textarea>
								<em class="help-block">Please enter the description products!</em>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="quatity">Enter
								the quatity</label>
							<div class="col-md-8">
								<sf:input type="number" path="quatity" id="quatity" placeholder="Enter the quatity"
									class="form-control"/> <em class="help-block">Please
									enter the quatity!</em>
							</div>
						</div>
