...
import br.com.vilara.vilarashopping.dto.OrderItem;
...
public class CheckoutHandler {
	...
	public List<Address> getShippingAddresses(CheckoutModel model) {
		...
		addresses.add(addresses.size(), userDAO.getBillingsAddress(model.getUser()));
	...
	public String saveOrder(CheckoutModel checkoutModel) {
		...
		Address billing = userDAO.getBillingsAddress(checkoutModel.getUser());		
